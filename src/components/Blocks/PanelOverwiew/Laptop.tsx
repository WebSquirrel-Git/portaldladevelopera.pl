...
export const Laptop = () => {
  ...
  return (
    <div ref={root} className="relative container">
      <Image
        src={DeweloperzyBlock}
        alt="Zarządzaj Deweloperami"
        className="deweloperzyblock scale-0 opacity-0 absolute w-[15%] h-fit object-contain object-top top-[13.8%] left-[24.6%]"
      />
      <Image
        src={DeweloperzyCard}
        alt="Zarządzaj Deweloperami"
      ...
      <Image
        ...
        className="inwestycjeblock scale-0 opacity-0 absolute w-[28.7%] h-fit object-contain object-top top-[38%] left-[51.1%]"
      />
      <Image
        src={InwestycjeCard}
        alt="Tworzenie inwestycji w 5 minut"
