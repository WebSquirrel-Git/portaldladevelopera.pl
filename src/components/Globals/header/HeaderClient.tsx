...
export const HeaderClient: React.FC<HeaderProps> = ({ data }) => {
  ...
  return (
    <header className="w-full flex fixed z-40 top-0 left-0 flex-row box-border justify-between items-center h-fit py-[14px] 2xl:py-[20px] px-4 2xl:px-[200px] xl:px-[100px] bg-black">
      <Link
